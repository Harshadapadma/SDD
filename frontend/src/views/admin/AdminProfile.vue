  ...
  <div class="page">
    ...
    <div class="page-header">
      <div>
        ...
        <p class="page-sub">Manage your administrative identity, contact details, and account security</p>
      </div>
          ...
          <div class="form-body">
            <div class="grid-2">
              <div class="form-group">
                ...
                <input v-model="form.name" placeholder="Admin Name" maxlength="255" @input="form.name = form.name.replace(/[^a-zA-Z\s\.\-']/g, '')" />
              </div>
              <div class="form-group">
                <label>Designation</label>
                <input v-model="form.designation" placeholder="e.g. Super Admin" maxlength="255" />
              </div>
              <div class="form-group">
                <label>Company Name</label>
                <input v-model="form.company_name" placeholder="e.g. Negen SDD" maxlength="255" />
              </div>
              <div class="form-group">
            ...
            <div class="form-footer">
              <button class="btn-ghost" @click="showPasswordForm = !showPasswordForm" type="button">
                <i class="fas fa-key"></i> {{ showPasswordForm ? 'Hide Password Settings' : 'Change Password' }}
              </button>
...
.status-badge {
  ...
  background: var(--orange-bg-subtle); color: var(--orange-accent); border: 1px solid var(--orange-border);
...
.req.err { color: var(--error-600); font-size: 11px; }

.form-footer { display: flex; justify-content: space-between; align-items: center; margin-top: 20px; padding-top: 16px; border-top: 1px solid var(--card-divider); }
