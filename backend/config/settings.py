...
EMAIL_USE_TLS = os.getenv('EMAIL_USE_TLS', 'True' if EMAIL_PORT == 587 else 'False').lower() in ('true', '1', 'yes')
EMAIL_USE_SSL = os.getenv('EMAIL_USE_SSL', 'True' if EMAIL_PORT == 465 else 'False').lower() in ('true', '1', 'yes')
EMAIL_TIMEOUT = 5  # 5-second socket timeout for SMTP operations
